...
export default {
      ...
      if (this.check_requrie_work()) {
        ...
        var response = await axios
          ...
          .then(function(response) {
            ...
            router.push({ name: self.push_name });
          })
  ...
  created() {
    this.setDefualtDate();
    if (this.$route.query.positions[0][0].position) {
      this.index = this.$route.query.index;
      this.arr_positions = this.$route.query.positions[this.index];
      this.work = this.$route.query.works[this.index];
      this.push_name = this.$route.query.page_name;

      for(var i = 0; i < this.$route.query.provinces[this.index].length; i++){
        this.province.push(this.$route.query.provinces[this.index][i].province);
      } 
      for(var i = 0; i < this.$route.query.regions[this.index].length; i++){
        this.region.push(this.$route.query.regions[this.index][i].region);
      } 
    } else {
